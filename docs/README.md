...
| Sauvegarde n8n | [`SAUVEGARDE_N8N.md`](./SAUVEGARDE_N8N.md) |

## Décisions d’architecture

- [`ADR-005-keycloak-gestion-identite.md`](./ADR/ADR-005-keycloak-gestion-identite.md)
- [`ADR-006-api-documentaire-ocr.md`](./ADR/ADR-006-api-documentaire-ocr.md)

En cas de contradiction, les sections autoritatives au début de
`ARCHITECTURE.md`, les ADR acceptés et les migrations appliquées prévalent sur
les annexes historiques.
